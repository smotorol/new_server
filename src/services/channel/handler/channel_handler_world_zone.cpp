...
bool ChannelHandler::HandleWorldMove(std::uint32_t dwProID, std::uint32_t n, const char* body, std::size_t body_len)
{
...
bool ChannelHandler::HandleWorldBenchMove(std::uint32_t dwProID, std::uint32_t n, const char* body, std::size_t body_len)
{
