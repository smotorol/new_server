...
class ControlWorldHandler : public dc::ServiceLineHandlerBase
{
public:
...
public:
    ControlWorldHandler(RegisterAckCallback on_register_ack, DisconnectCallback on_disconnect);
    ~ControlWorldHandler() override = default;
